...
class Category extends MY_Controller {
    ...
    function index() {
        $this->template->rander("category/index");
    }
    ...
    function list_data() {
        $list_data = $this->Category_model->get_details()->result();
        $result = array();
    ...
    private function _make_row($data) {
        return array(
            ...
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_category'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("category/delete"), "data-action" => "delete"))
        );
    }
