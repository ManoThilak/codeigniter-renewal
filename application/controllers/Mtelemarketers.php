...
class Mtelemarketers extends MY_Controller {
    ...
    function index() {
        ...
        $view_data['groups_dropdown'] = json_encode($this->get_clients_dropdown(true));
        $view_data['from_dropdown'] = json_encode($this->get_from_dropdown(true));
        $view_data['to_dropdown'] = json_encode($this->get_to_dropdown(true));
        $view_data['status_dropdown'] = json_encode($this->get_status_dropdown(true));
        $view_data['giftfor_dropdown'] = json_encode($this->get_giftfor_dropdown(true));
        $view_data['telemarketers_dropdown'] = json_encode($this->get_telemarketers_dropdown(true));
        //$view_data['telemarketers_dropdown'] = array("" => "-") + $this->Telemarketers_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0));
        $this->template->rander("mtelemarketers/index", $view_data);
    }
    ...
    function cindex() {
      //  $this->access_only_allowed_members();
        ...
        if ($this->login_user->user_type === "staff") {
            ...
            //$view_data['groups_dropdown'] = json_encode($this->_get_groups_dropdown_select2_data(true));
        $view_data['clients_dropdown'] = json_encode($this->get_clients_dropdown(true));
        $view_data['salesmanager_dropdown'] = json_encode($this->get_salesmanager_dropdown(true));
        $view_data['from_dropdown'] = json_encode($this->get_from_dropdown(true));
        $view_data['to_dropdown'] = json_encode($this->get_to_dropdown(true));
        $view_data['status_dropdown'] = json_encode($this->get_status_dropdown(true));
        $view_data['telemarketers_dropdown'] = json_encode($this->get_telemarketers_dropdown(true));
        $view_data['complete_dropdown'] = json_encode($this->get_complete_dropdown(true));
        //$view_data['telemarketers_dropdown'] = array("" => "-") + $this->Telemarketers_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0));
        $this->template->rander("mtelemarketers/telereport/index", $view_data);
            } else {
                //$view_data['groups_dropdown'] = json_encode($this->_get_groups_dropdown_select2_data(true));
        $view_data['clients_dropdown'] = json_encode($this->get_clients_dropdown(true));
        $view_data['salesmanager_dropdown'] = json_encode($this->get_salesmanager_dropdown(true));
    ...
    function modal_form() {
        ...
        //$view_data['model_info'] = $this->Mtelemarketers_model->get_one($client_id);
        $model_info = $this->Mtelemarketers_model->get_one($client_id);
        $view_data["currency_dropdown"] = $this->_get_currency_dropdown_select2_data();

        //$view_data["package_dropdown"] = $this->_get_package_data();
        //$view_data['packagetype_dropdown'] = array("" => "-") + $this->Package_types_model->get_dropdown_list(array("title"), "id", array("deleted" => 0));
         $view_data['clients_dropdown'] = array("" => "-") + $this->Clients_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0));
         $view_data['telemarketers_dropdown'] = array("" => "-") + $this->Telemarketers_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0));
        //$view_data['package_dropdown'] = array("" => "-") + $this->Package_groups_model->get_dropdown_list(array("package_name","tot_contacts"), "id", array("deleted" => 0));
         //$view_data['status_dropdown'] = array("UnAssigned" => "UnAssigned");
         //$view_data['status_dropdown'] = json_encode($this->get_status_dropdown(true));
         $view_data['status_dropdown'] = $this->Status_master_model->get_dropdown_list(array("title"), "id", array("id" => 2));
         $view_data['complete_dropdown'] = $this->Complete_master_model->get_dropdown_list(array("title"), "id", array("deleted" => 0));
          //$view_data['client_id'] = 2;

        //prepare groups dropdown list
        $view_data['groups_dropdown'] = $this->_get_groups_dropdown_select2_data();
        //$view_data['giftfor_dropdown'] = json_encode($this->get_giftfor_dropdown(true));
        $view_data['giftfor_dropdown'] = array("" => "-") + $this->Giftfor_master_model->get_dropdown_list(array("title"), "id", array("deleted" => 0));
       ...
       // $view_data["custom_fields"] = $this->Custom_fields_model->get_combined_details("clients", $client_id, $this->login_user->is_admin, $this->login_user->user_type)->result();
        ...
        $this->load->view('mtelemarketers/modal_form', $view_data);
    }



    function customers_tele_fields() {
        //$this->access_only_allowed_members();
        ...
        $view_data['clients_dropdown'] = array("" => "-") + $this->Clients_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0));
         ...
         if ($this->login_user->telecallers_id === "0") { 
            $view_data['telemarketers_dropdown'] = array("" => "-") + $this->Telemarketers_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0));

          } else {
            $view_data['telemarketers_dropdown'] = $this->Telemarketers_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0,"id" => $this->login_user->telecallers_id));
        ...
        //$view_data['package_dropdown'] = array("" => "-") + $this->Package_groups_model->get_dropdown_list(array("package_name","tot_contacts"), "id", array("deleted" => 0));
         ...
         $projects = $this->Mtelemarketers_model->get_dropdown_list(array("id"), "id", array("client_id" => $project_client_id));
        $suggestion = array(array("id" => "", "text" => "-"));
        foreach ($projects as $key => $value) {
            $suggestion[] = array("id" => $key, "text" => $value);
        }
        ...
        $this->load->view('mtelemarketers/customers_tele_modal_form', $view_data);
    }
    ...
    function save() {
        ...
        $gid = $this->input->post('giftfor_id');
        ...
        $data = array(
            ...
            "complete_id" => $this->input->post('complete_id'),
             "religion_id" => $this->input->post('religion_id'),
              "sub_religion_id" => $this->input->post('sub_religion_id'),
              "gift_id" => $this->input->post('gift_id'),
              "giftfor_id" => $this->input->post('giftfor_id'),
            "next_followupdate" => $this->input->post('next_followupdate'),
        ...
        // if (get_setting("disallow_duplicate_client_company_name") == "1" && $this->Customers_model->is_duplicate_company_name($data["company_name"], $client_id)) {
        //     echo json_encode(array("success" => false, 'message' => lang("account_already_exists_for_your_company_name")));
        //     exit();
        // }


        $save_id = $this->Mtelemarketers_model->save($data, $client_id);
        if ($save_id) {
    ...
    function savetele() {
        ...
        validate_submitted_data(array(
            ...
            "telemarketer_id" => "numeric|required",
            "client_id" => "numeric|required",
            "from_id" => "required",
            "to_id" => "required"
        ...
        $telemarketer_id = $this->input->post('telemarketer_id');
        $client_id = $this->input->post('client_id');
       ...
       // $this->Customers_model->insert_datas($telemarketer_id, $client_id, $from_id, $to_id);

         if ($this->Mtelemarketers_model->insert_datas($telemarketer_id, $client_id, $from_id, $to_id)) {
            echo json_encode(array("success" => true, 'message' => lang('record_assigned')));
        } else {
            echo json_encode(array("success" => false, 'message' => lang('record_cannot_be_assigned')));
        }
        ...
        //$save_id = $this->Customers_model->save($data, $client_id);
        // if ($save_id) {
        //     save_custom_fields("clients", $save_id, $this->login_user->is_admin, $this->login_user->user_type);
    ...
    function get_fromid_suggestion($client_id = 0, $telemarketer_id = 0) {
        //$this->access_only_allowed_members();

        $projects = $this->Mtelemarketers_model->get_dropdown_list(array("id"), "id", array("client_id" => $client_id,"complete_id" => 1,"telemarketer_id" => $telemarketer_id,"status_id" => 1,"transfer_id" => 2));
        $suggestion = array(array("id" => "", "text" => "-"));
        foreach ($projects as $key => $value) {
            $suggestion[] = array("id" => $key, "text" => $value);
        }
    ...
    // function get_id_suggestion($client_id = 0) {
    //     $this->access_only_allowed_members();

    //     $projects = $this->Customers_model->get_dropdown_list(array("id"), "id", array("client_id" => $client_id));
    //     $suggestion = array(array("id" => "", "text" => "-"));
    //     foreach ($projects as $key => $value) {
    //         $suggestion[] = array("id" => $key, "text" => $value);
    //     }
    ...
    function delete() {
        ...
        if ($this->Mtelemarketers_model->delete_client_and_sub_items($id)) {
       ...
       // $this->access_only_allowed_members();
        $custom_fields = $this->Custom_fields_model->get_available_fields_for_table("clients", $this->login_user->is_admin, $this->login_user->user_type);
         ...
         if ($this->login_user->telecallers_id === "0") {
            ...
            $telemarketer_id = $this->login_user->telecallers_id;
        }
        ...
        $list_data = $this->Mtelemarketers_model->get_details_rep($options)->result();
        $result = array();
        foreach ($list_data as $data) {
            $result[] = $this->_make_rep_row($data, $custom_fields);
        }
    ...
    function list_data() {
        ...
        $list_data = $this->Mtelemarketers_model->get_details($options)->result();
        $result = array();
        foreach ($list_data as $data) {
     ...
     function list_data_of_client($client_id = 0) {
    ...
    private function _row_data($id) {
        ...
        $data = $this->Mtelemarketers_model->get_details($options)->row();
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $row_data = array($data->id,
             //anchor(get_uri("customers/view/" . $data->id), $data->customer_name),
            //format_to_date($data->assign_date, false),
            format_to_date($data->next_followupdate, false),
            //$data->assign_date,
            $data->customer_name,
             $data->client_name,
            
              //$data->birth_date,
             format_to_date($data->birth_date, false),
             $data->anniversary_date,
             format_to_date($data->anniversary_date, false),
             $data->phone,
             //$data->email,
             $data->status
        ...
        if ($this->login_user->is_admin) {
            $row_data[] = modal_anchor(get_uri("mtelemarketers/modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_customer'), "data-post-id" => $data->id))
                . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_telemarketer'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("mtelemarketers/delete"), "data-action" => "delete-confirmation"));
    ...
    private function _make_rep_row($data, $custom_fields) {
        ...
        $row_data = array($data->id,
            ...
            //format_to_date($data->assign_date, false),
            format_to_date($data->assign_date, false),
            format_to_date($data->completed_date, false),
            //$data->completed_date,
            $data->customer_name,
             $data->client_name,
        ...
        foreach ($custom_fields as $field) {
            ...
            $row_data[] = modal_anchor(get_uri("mtelemarketers/modal_form"), "", array("class" => "edit", "title" => lang('edit_customer'), "data-post-id" => $data->id))
                . js_anchor("", array('title' => lang('delete_telemarketer'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("mtelemarketers/delete"), "data-action" => "delete-confirmation"));
    ...
    function view($client_id = 0, $tab = "") {
        ...
        if ($client_id) {
            ...
            $client_info = $this->Mtelemarketers_model->get_details($options)->row();
            if ($client_info && !$client_info->is_lead) {
                ...
                $this->template->rander("mtelemarketers/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add") {
        if ($client_id) {
            ...
            if ($type === "add") {
                $this->Mtelemarketers_model->add_remove_star($client_id, $this->login_user->id, $type = "add");
                $this->load->view('mtelemarketers/star/starred', $view_data);
            } else {
                $this->Mtelemarketers_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                $this->load->view('mtelemarketers/star/not_starred', $view_data);
            }
        }
    }

    function show_my_starred_clients() {
        $view_data["clients"] = $this->Mtelemarketers_model->get_starred_clients($this->login_user->id)->result();
        $this->load->view('mtelemarketers/star/clients_list', $view_data);
    }
    ...
    function projects($client_id) {
        ...
        $view_data['client_id'] = $client_id;
        $this->load->view("mtelemarketers/projects/index", $view_data);
    }
    ...
    function payments($client_id) {
       // $this->access_only_allowed_members();
        ...
        if ($client_id) {
            $view_data["client_info"] = $this->Mtelemarketers_model->get_one($client_id);
            $view_data['client_id'] = $client_id;
            $this->load->view("mtelemarketers/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id) {
      //  $this->access_only_allowed_members();
        ...
        if ($client_id) {
            ...
            $this->load->view("mtelemarketers/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id) {
       // $this->access_only_allowed_members();
        ...
        if ($client_id) {
            ...
            $this->load->view("mtelemarketers/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id) {
        ...
        if ($client_id) {
            ...
            $this->load->view("mtelemarketers/estimates/estimates", $view_data);
        }
    }
    ...
    function estimate_requests($client_id) {
       // $this->access_only_allowed_members();
        ...
        if ($client_id) {
            $view_data['client_id'] = $client_id;
            $this->load->view("mtelemarketers/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id) {
       // $this->access_only_allowed_members();
        ...
        if ($client_id) {
            $view_data['client_id'] = $client_id;
            $this->load->view("mtelemarketers/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "") {
        ...
        if ($view_type == "page_view") {
            ...
            $this->template->rander("mtelemarketers/files/index", $view_data);
        } else {
            $this->load->view("mtelemarketers/files/index", $view_data);
        }
    }
    ...
    function file_modal_form() {
        ...
        $view_data['client_id'] = $client_id;
        $this->load->view('mtelemarketers/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data) {
        ...
        $description = "<div class='pull-left'>" .
                js_anchor(remove_file_prefix($data->file_name), array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("mtelemarketers/view_file/" . $data->id)));
        ...
        $options = anchor(get_uri("mtelemarketers/download_file/" . $data->id), "<i class='fa fa fa-cloud-download'></i>", array("title" => lang("download")));

        if ($this->login_user->user_type == "staff") {
            $options .= js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_file'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("mtelemarketers/delete_file"), "data-action" => "delete-confirmation"));
        }
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            $this->load->view("mtelemarketers/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "") {
       // $this->access_only_allowed_members_or_contact_personally($contact_id);
        ...
        $view_data['client_info'] = $this->Mtelemarketers_model->get_one($view_data['user_info']->client_id);
        $view_data['tab'] = $tab;
        if ($view_data['user_info']->user_type === "client") {
            ...
            $this->template->rander("mtelemarketers/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences() {
        ...
        $this->load->view("mtelemarketers/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($client_id = 0) {
       // $this->access_only_allowed_members();
        ...
        $this->load->view("mtelemarketers/contacts/index", $view_data);
    }
    ...
    function add_new_contact_modal_form() {
       // $this->access_only_allowed_members();
        ...
        $this->load->view('mtelemarketers/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0) {
        if ($contact_id) {
            ...
            $this->load->view('mtelemarketers/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($client_id = 0) {
        if ($client_id) {
           // $this->access_only_allowed_members_or_client_contact($client_id);
            ...
            $view_data['label_column'] = "col-md-2";
            $view_data['field_column'] = "col-md-10";
            $this->load->view('mtelemarketers/contacts/company_info_tab', $view_data);
        }
    }
    ...
    function save_contact() {
        ...
        if (!$contact_id) {
            ...
            $user_data["password"] = password_hash($this->input->post("login_password"), PASSWORD_DEFAULT);
        ...
        $primary_contact = $this->Mtelemarketers_model->get_primary_contact($client_id);
        if (!$primary_contact) {
    ...
    function save_account_settings($user_id) {
        ...
        if ($this->Users_model->save($account_data, $user_id)) {
            ...
            if ($this->input->post('email_login_details')) {
                ...
                $parser_data["SIGNATURE"] = $email_template->signature;
                $parser_data["USER_FIRST_NAME"] = $this->input->post('first_name');
                $parser_data["USER_LAST_NAME"] = $this->input->post('last_name');
    ...
    private function _make_contact_row($data, $custom_fields, $hide_primary_contact_label = false) {
        ...
        $contact_link = anchor(get_uri("mtelemarketers/contact_profile/" . $data->id), $full_name . $primary_contact) . $removal_request_pending;
        if ($this->login_user->user_type === "client") {
            $contact_link = $full_name; //don't show clickable link to client
        }

        $client_info = $this->Mtelemarketers_model->get_one($data->client_id);

        $row_data = array(
            $user_avatar,
            $contact_link,
            anchor(get_uri("mtelemarketers/view/" . $data->client_id), $client_info->customer_name),
            $data->job_title,
            $data->email,
        ...
        $row_data[] = js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_contact'), "class" => "delete", "data-id" => "$data->id", "data-action-url" => get_uri("mtelemarketers/delete_contact"), "data-action" => "delete"));
    ...
    function invitation_modal() {
       ...
       // $this->access_only_allowed_members_or_client_contact($client_id);
        ...
        $view_data["client_info"] = $this->Mtelemarketers_model->get_one($client_id);
        $this->load->view('mtelemarketers/contacts/invitation_modal', $view_data);
    }
    ...
    function users() {
        if ($this->login_user->user_type === "client") {
            ...
            $this->template->rander("mtelemarketers/contacts/users", $view_data);
        }
    }
    ...
    function import_clients_modal_form() {
       // $this->access_only_allowed_members();
        $this->load->view("mtelemarketers/import_customers_modal_form");
    }
            ...
            foreach ($excel_file as $key => $value) {
                ...
                if ($key !== 0) {
                    ...
                    foreach ($value as $row_data_key => $row_data_value) {
                        ...
                        if ($row_data_value) {
                            if ($header_key_value == "client_name") {
                                //we've to make client groups data differently
                                $client_data["client_id"] = $this->_get_client_group_ids($row_data_value);
                            } else if ($header_key_value == "customer_name") {
                                $client_data["customer_name"] = $row_data_value;
                            } else if ($header_key_value == "phone") {
                                $client_data["phone"] = $row_data_value;
                            } else if ($header_key_value == "contact_email") {
                                $client_data["email"] = $row_data_value;
                            } else if ($header_key_value == "birth_date") {
                                $client_data["birth_date"] = $row_data_value;
                            } else if ($header_key_value == "anniversary_date") {
                                $client_data["anniversary_date"] = $row_data_value;
                            } else {
                    ...
                    if ($client_data && count($client_data)) {
                        //save client data
                        $client_save_id = $this->Mtelemarketers_model->save($client_data);
    ...
    private function _get_client_group_ids($client_groups_data) {
        ...
        if ($explode_client_groups && count($explode_client_groups)) {
            ...
            foreach ($explode_client_groups as $group) {
                $group_id = "";
                $existing_group = $this->Clients_model->get_one_where(array("company_name" => $group, "deleted" => 0));
                if ($existing_group->id) {
                    ...
                    $group_data = array("company_name" => $group);
                    $group_id = $this->Clients_model->save($group_data);
                }
       ...
       // $this->access_only_allowed_members();
        ...
        foreach ($excel_file as $row_key => $value) {
            if ($row_key == 0) {
                ...
                $has_customer_name = get_array_value($value, 1) ? true : false;

                foreach ($value as $key => $row_data) {
                    $has_error_class = false;

                    if (!$got_error_header) {
                        $row_data_validation = $this->_row_data_validation_and_get_error_message($key, $row_data, $has_customer_name);
    ...
    private function _row_data_validation_and_get_error_message($key, $data, $has_customer_name) {
        $allowed_headers = $this->_get_allowed_headers();
        $header_value = get_array_value($allowed_headers, $key);

        //company name field is required
        if ($header_value == "phone" && !$data) {
            return lang("import_client_error_phone_field_required");
        }
    ...
    function download_sample_excel_file() {
     //   $this->access_only_allowed_members();
        download_app_files(get_setting("system_file_path"), serialize(array(array("file_name" => "import-customers-sample.xlsx"))));
    }

    function gdpr() {
        $view_data["user_info"] = $this->Users_model->get_one($this->login_user->id);
        $this->load->view("mtelemarketers/contacts/gdpr", $view_data);
    }
    ...
    private function _make_export_data($user_info) {
        ...
        $data = strtoupper(lang("general_info")) . "\n";

        //add general info
        foreach ($required_general_info_array as $field) {
            if ($user_info->$field) {
                if ($field == "created_at") {
                    $data .= lang("created") . ": " . format_to_datetime($user_info->$field) . "\n";
                } else if ($field == "gender") {
                    $data .= lang($field) . ": " . ucfirst($user_info->$field) . "\n";
                } else if ($field == "skype") {
                    $data .= "Skype: " . ucfirst($user_info->$field) . "\n";
                } else {
                    $data .= lang($field) . ": " . $user_info->$field . "\n";
                }
            }
        }

        $data .= "\n\n";
        $data .= strtoupper(lang("client_info")) . "\n";

        //add company info
        $client_info = $this->Mtelemarketers_model->get_one($user_info->client_id);
        ...
        foreach ($required_client_info_array as $field) {
            if ($client_info->$field) {
                $data .= lang($field) . ": " . $client_info->$field . "\n";
            }
        }

        $data .= "\n\n";
        $data .= strtoupper(lang("social_links")) . "\n";
    ...
    function request_my_account_removal() {
        if (get_setting("enable_gdpr") && get_setting("clients_can_request_account_removal")) {
            ...
            redirect("mtelemarketers/contact_profile/$user_id/gdpr");
        }
    }
