<div class="tab-content">
    ...
    echo form_open(get_uri("salesmanager/save_my_preferences/"), array("id" => "my-preferences-form", "class" => "general-form dashed-row white", "role" => "form"));
    ?>
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <?php echo modal_anchor(get_uri("salesmanager/keyboard_shortcut_modal_form/"), "<i class='fa fa-info'></i>", array("class" => "btn btn-default keyboard-shortcut-info-icon", "title" => lang('keyboard_shortcuts_info'), "data-post-user_id" => $this->login_user->id)); ?>
            </div>
