...
class Invoices_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sql = "SELECT $invoices_table.*,salesmanager.company_name as entry_idd, $clients_table.currency, $clients_table.salesmanager_id, $clients_table.currency_symbol, $clients_table.company_name, $projects_table.title AS project_title,sevice_table.combined_titles,
