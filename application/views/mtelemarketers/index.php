<div id="page-content" class="p20 clearfix">
    <div class="panel clearfix">
        <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li><a id="clients-button" class="active" role="presentation" href="javascript:;" data-target="#clients"><?php echo lang('manage_telemarketers'); ?></a></li>
            <!-- <li><a role="presentation" href="<?php echo_uri("telemarketers/contacts/"); ?>" data-target="#contacts"><?php echo lang('contacts'); ?></a></li> -->
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                   ...
                   <!--  <?php echo modal_anchor(get_uri("telemarketers/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_telemarketer'), array("class" => "btn btn-default", "title" => lang('add_telemarketer'))); ?> -->
                    <?php echo modal_anchor(get_uri("mtelemarketers/customers_tele_fields"), "<i class='fa fa-plus-circle'></i> " . lang('assign_to_gift'), array("class" => "btn btn-default", "title" => lang('assign_to_gift'))); ?> 
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadClientsTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("mtelemarketers/list_data") ?>',
            filterDropdown: [
                ...
                <?php if ($this->login_user->telecallers_id === "0") { ?>
