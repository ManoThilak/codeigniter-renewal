...
<div class="form-group">
    ...
    <div class="<?php echo $field_column; ?>">
        <?php
        echo form_dropdown("telemarketer_id", $clients_dropdown, array($model_info->telemarketer_id), "class='select2 validate-hidden' id='telemarketer_id' data-rule-required='true' data-msg-required='" . lang('field_required') . "'");
                ?>
    </div>
</div>
<div class="form-group">
