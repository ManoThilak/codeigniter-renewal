...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="invoice_payment_date" class=" col-md-3">Next Followup Date</label>
        <div class="col-md-9">
            <?php
    ...
    <div class="form-group">
        <label for="invoice_payment_note" class="col-md-3"><?php echo lang('comments'); ?></label>
        <div class=" col-md-9">
            <?php
    ...
    <div class="form-group">
        <label for="renewal_status" class=" col-md-3">Renewal Status</label>
        <div class="col-md-9">
            <?php
            echo form_dropdown("renewal_status", $renewal_status_dropdown, array($model_info->renewal_status), "class='select2 tax-select2' id='renewal_status'");
            ?>
        </div>
    </div>
</div>
