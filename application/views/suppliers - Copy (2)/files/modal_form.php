<?php echo form_open(get_uri("suppliers/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="client_id" value="<?php echo $client_id; ?>" />
    <?php
    $this->load->view("includes/multi_file_uploader", array(
        "upload_url" =>get_uri("suppliers/upload_file"),
        "validation_url" =>get_uri("suppliers/validate_file"),
    ));
    ?>
</div>
