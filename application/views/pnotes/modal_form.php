<?php echo form_open(get_uri("pnotes/save"), array("id" => "note-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        var uploadUrl = "<?php echo get_uri("pnotes/upload_file"); ?>";
        var validationUri = "<?php echo get_uri("pnotes/validate_notes_file"); ?>";
