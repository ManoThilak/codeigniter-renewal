<div class="clearfix">
    <?php if ($show_invoice_info) { ?>
        ...
        <?php if (!in_array("payments", $hidden_menu) && !in_array("invoices", $hidden_menu)) { ?>
            ...
            <div class="col-md-3 col-sm-6  widget-container">
                <?php $this->load->view("clients/info_widgets/tab", array("tab" => "package")); ?>
            </div>
            <div class="col-md-3 col-sm-6  widget-container">
                <?php $this->load->view("clients/info_widgets/tab", array("tab" => "package_types")); ?>
            </div>
            <div class="col-md-3 col-sm-6  widget-container">
                <?php $this->load->view("clients/info_widgets/tab", array("tab" => "total_gifts")); ?>
            </div>
        <?php } ?>
