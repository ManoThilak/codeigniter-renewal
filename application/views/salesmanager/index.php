<div id="page-content" class="p20 clearfix">
    <div class="panel clearfix">
        <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li><a id="clients-button" class="active" role="presentation" href="javascript:;" data-target="#clients"><?php echo lang('salesmanager'); ?></a></li>
            <!-- <li><a role="presentation" href="<?php echo_uri("salemanager/contacts/"); ?>" data-target="#contacts"><?php echo lang('contacts'); ?></a></li> -->
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    <!-- <?php echo modal_anchor(get_uri("salesmanager/import_sales_modal_form"), "<i class='fa fa-upload'></i> " . lang('import_salesmanager'), array("class" => "btn btn-default", "title" => lang('import_salesmanager'))); ?> -->
                    <?php echo modal_anchor(get_uri("salesmanager/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_salesmanager'), array("class" => "btn btn-default", "title" => lang('add_salesmanager'))); ?>
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadClientsTable = function (selector) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("salesmanager/list_data") ?>',
            filterDropdown: [
            ...
            columns: [
                ...
                {title: "<?php echo lang("salesmanager_name") ?>"},
                {title: "<?php echo lang("phone") ?>"},
                
                {title: "<?php echo lang("commission_amt") ?>"},
