        ...
        <div class="panel-body">
            ...
            <?php if (get_setting("allow_clients_to_export_their_data")) { ?>
                <div class="form-group">
                    ...
                    <div class=" col-md-10">
                        <?php echo anchor(get_uri("giftpack/export_my_data/"), lang("export"), array("class" => "btn btn-primary", "title" => lang('export_my_data'))); ?>
                    </div>
                </div>
            <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <div class=" col-md-10">
                        <?php if ($user_info->requested_account_removal) { ?>
                            ...
                            echo anchor(get_uri("giftpack/request_my_account_removal/"), lang("apply"), array("class" => "btn btn-danger", "title" => lang('i_want_to_remove_my_account')));
                        }
                        ?>
                    </div>
                </div>
