        ...
        <?php } else { ?>
            ...
            <div class="panel panel-default">
                ...
                <div style="float:right;">
                    <?php echo modal_anchor(get_uri("invoice_payments/payment_modal_form"), "<i class='fa fa-plus-circle'></i> " . 'Add Next Followup', array("class" => "btn btn-default mb0", "data-post-invoice_id" => $invoice_info->id, "title" => 'Add Next Followup')); ?>
                </div>
    ...
    $(document).ready(function () {
        ...
        $("#invoice-payment-table").appTable({
            ...
            columns: [
                ...
                {visible: false, searchable: false},
                {title: 'Next Followup Date ', "class": "w25p", "iDataSort": 1},
                // {title: '<?php echo lang("payment_method") ?>', "class": "w15p"},
                {title: '<?php echo lang("comments") ?>'},
