...
class Invoices extends MY_Controller {
    ...
    function all_invoice() {
        $this->load->view("invoices/all_invoice");
    }
    ...
    function modal_form() {
        ...
        if ($this->login_user->salesmanager_id === "0") {
            ...
            $view_data['clients_dropdown'] = array("" => "-") + $this->Clients_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0,"salesmanager_id" => $this->login_user->salesmanager_id));
        }



        // if ($this->login_user->is_admin) {
        //     $view_data['entry_dropdown'] = array("" => "Admin") ;
        // } else if (!$this->login_user->salesmanager_id === "0") {
            
        //     $view_data['entry_dropdown'] =  $this->Salesmanager_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0,"id" => $this->login_user->salesmanager_id));
        // } 
        ...
        if ($this->login_user->salesmanager_id === "0") {
            ...
            if ($this->login_user->is_admin) {
                $view_data['entry_dropdown'] =  array("Admin" => "Admin") ;
            } else {
                $view_data['entry_dropdown'] =  array("Accounts" => "Accounts") ;
            }
