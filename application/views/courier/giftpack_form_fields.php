...
<!-- <div class=" form-group">
    <label for="next_followupdate" class="<?php echo $label_column; ?>"><?php echo lang('next_followupdate'); ?><small class="req"> *</small></label>
    <div class="<?php echo $field_column; ?>">
        <?php
            echo form_input(array(
 ...
 <div class=" form-group">
    <label for="birth_date" class="<?php echo $label_column; ?>"><?php echo lang('birth_date'); ?><small class="req"> *</small></label>
    <div class="<?php echo $field_column; ?>">
        <?php
            echo form_input(array(
                "id" => "birth_date",
...
<div class="form-group">
    <label for="anniversary_date" class="<?php echo $label_column; ?>"><?php echo lang('anniversary_date'); ?><small class="req"> *</small></label>
    <div class="<?php echo $field_column; ?>">
        <?php
        echo form_input(array(
                "id" => "anniversary_date",
...
setDatePicker("#anniversary_date,#birth_date,#next_followupdate");
