<?php echo form_open(get_uri("pinvoices/save_item"), array("id" => "invoice-item-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#invoice_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("pinvoices/get_invoice_item_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("pinvoices/get_invoice_item_info_suggestion"); ?>",
