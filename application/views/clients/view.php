<div class="page-title clearfix no-border bg-off-white">
    <h1>
        <?php echo lang('client_details') . " - " . $client_info->company_name ?>
         <?php if ($client_info->renewal_status == 0) { ?>

         <span class='mt0 label label-info large ml10 clickable'  title='label'>Live</span>
         <?php } else { ?>
            <span class='mt0 label label-info large ml10 clickable' style="background-color:#ff0000d9" title='label'>Lost</span>
        <?php } ?>
