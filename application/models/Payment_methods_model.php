...
class Payment_methods_model extends Crud_model {
    ...
    function get_settings($type = "") {
        $settings = array(
            ...
            "razorpay" => array(
                array("name" => "pay_button_text", "text" => lang("pay_button_text"), "type" => "text", "default" => "RazorPay"),
                
                array("name" => "razor_key", "text" => "Razor Key", "type" => "text", "default" => ""),
                array("name" => "razor_secret", "text" => "Secret Key", "type" => "text", "default" => "")
            ),
            "khipu" => array(
