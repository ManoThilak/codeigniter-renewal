<?php echo form_open(get_uri("couriersent/save_client_from_excel_file"), array("id" => "import-client-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-client-modal-body">
    <div id="upload-area">
        <?php
        $this->load->view("includes/multi_file_uploader", array(
            "upload_url" => get_uri("couriersent/upload_excel_file"),
            "validation_url" => get_uri("couriersent/validate_import_clients_file"),
            "max_files" => 1,
...
<div class="modal-footer">
    <!-- <?php echo anchor("couriersent/download_sample_excel_file", "<i class='fa fa-cloud-download'></i> " . lang("download_sample_file"), array("title" => lang("download_sample_file"), "class" => "btn btn-default pull-left")); ?> -->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $nextButton.click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('couriersent/validate_import_clients_file_data') ?>",
                type: 'POST',
                dataType: 'json',
