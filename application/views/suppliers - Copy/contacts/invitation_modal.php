<?php echo form_open(get_uri("suppliers/send_invitation"), array("id" => "invitation-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <br />
    <div class="form-group mb15">
        <input type="hidden" name="client_id" value="<?php echo $client_info->id; ?>" />

        <label for="email" class=" col-md-12"><?php echo sprintf(lang('invite_an_user'), $suppliers_info->company_name); ?></label>
        <div class="col-md-12">
            <?php
