<div id="page-content" class="p20 clearfix">
    <div class="panel clearfix">
        <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li><a id="clients-button" class="active" role="presentation" href="javascript:;" data-target="#clients"><?php echo lang('courier'); ?></a></li>
            <!-- <li><a role="presentation" href="<?php echo_uri("courier/contacts/"); ?>" data-target="#contacts"><?php echo lang('contacts'); ?></a></li> -->
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                   ...
                   <!--  <?php echo modal_anchor(get_uri("courier/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_telemarketer'), array("class" => "btn btn-default", "title" => lang('add_telemarketer'))); ?> -->
                   <!--  <?php echo modal_anchor(get_uri("courier/customers_tele_fields"), "<i class='fa fa-plus-circle'></i> " . lang('sent_courier'), array("class" => "btn btn-default", "title" => lang('sent_courier'))); ?>  -->
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadClientsTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("courier/list_data_report") ?>',
            filterDropdown: [
