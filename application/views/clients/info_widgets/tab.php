...
if ($tab == "projects") {
    ...
    $panel = "panel-sky";
    $icon = "fa-th-large";
    if (property_exists($client_info, "package_groups")) {
        $value = ($client_info->package_groups);
    }
} else if ($tab == "package_types") {
    $panel = "panel-sky";
    $icon = "fa-th-large";
    if (property_exists($client_info, "package_types")) {
        $value = ($client_info->package_types);
    }
} else if ($tab == "total_gifts") {
    $panel = "panel-sky";
    $icon = "fa-gift";
    if (property_exists($client_info, "total_gifts")) {
        $value = ($client_info->total_gifts);
    }
}
?>
