...
class Stockout extends MY_Controller {
    ...
    $list_data = $this->Stockin_model->get_details()->result();
        $result = array();
        //$this->template->rander("stock/stockout/index");
    }
    ...
    function save() {
        ...
        //   if ($this->input->post('expense_invoice_id') > 0) {
        //     validate_submitted_data(array(
        //        "expense_client_id" => "required",
        //      ));
    ...
    function list_data() {
        ...
        $custom_fields = $this->Custom_fields_model->get_available_fields_for_table("expenses", $this->login_user->is_admin, $this->login_user->user_type);
        $options = array("start_date" => $start_date, "end_date" => $end_date, "godown_id" => $godown_id, "item_id" => $item_id, "supplier_id" => $supplier_id, "custom_fields" => $custom_fields);
