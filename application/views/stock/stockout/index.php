<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul id="expenses-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang("stockinward"); ?></h4></li>
            ...
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    <?php echo modal_anchor(get_uri("expenses/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_stock'), array("class" => "btn btn-default mb0", "title" => lang('add_expense'))); ?>
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadExpensesTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("stockin/list_data") ?>',
            dateRangeType: dateRange,
            filterDropdown: [
                {name: "category_id", class: "w200", options: <?php echo $godowns_dropdown; ?>},
                {name: "user_id", class: "w200", options: <?php echo $items_dropdown; ?>},
                {name: "project_id", class: "w200", options: <?php echo $suppliers_dropdown; ?>}
            ],
            order: [[0, "asc"]],
