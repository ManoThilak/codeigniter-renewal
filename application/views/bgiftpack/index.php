<div id="page-content" class="p20 clearfix">
    <div class="panel clearfix">
        <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <!-- <li><a role="presentation" href="<?php echo_uri("bgiftpack/contacts/"); ?>" data-target="#contacts"><?php echo lang('contacts'); ?></a></li> -->
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                   ...
                   <!--  <?php echo modal_anchor(get_uri("bgiftpack/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_telemarketer'), array("class" => "btn btn-default", "title" => lang('add_telemarketer'))); ?> -->
                    <?php echo modal_anchor(get_uri("bgiftpack/customers_tele_fields"), "<i class='fa fa-plus-circle'></i> " . lang('assign_to_courier'), array("class" => "btn btn-default", "title" => lang('assign_to_courier'))); ?> 
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadClientsTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("bgiftpack/list_data") ?>',
            filterDropdown: [
