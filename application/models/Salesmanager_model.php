...
class Salesmanager_model extends Crud_model {

    private $table = null;

    function __construct() {
        $this->table = 'salesmanager';
    ...
    function delete_client_and_sub_items($client_id) {
        ...
        //delete contacts
        $delete_contacts_sql = "UPDATE $users_table SET $users_table.deleted=1 WHERE $users_table.salesmanager_id=$client_id; ";
