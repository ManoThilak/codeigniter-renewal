...
<table cellpadding="0" cellspacing="0" width="100%">
    <tr>
        ...
        foreach ($students as $student) {
                            ...
                            <div class="staround">
                                <div class="cardleft">
                                    ...
                                    <!-- <li><h1><?php echo $this->lang->line('from'); ?></h1></li>
                                      <li><img src="<?php echo base_url('files/timeline_files/' . $picname); ?>" width="300" height="80" /></li>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3" !important>

                <ul class="stlist" style="float : right;display: inline-block;">
