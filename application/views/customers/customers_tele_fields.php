...
//             $.ajax({
//                 type: "GET",
//                 url: "<?php echo get_uri("customers/get_totid_suggestion") ?>" + "/" + client_id + "/" + telemarketer_id + "/" + fromid + "/" + toid,
//                 dataType: "json",
//                 success: function (result) {
//                     //$("#tot_cus").show().val("");
//                     $('#tot_cus').html(data.result);
//                     // $("#to_id").show().val("");
//                     // $('#to_id').select2({data: result});
//                     // appLoader.hide();
//                 }
...
//         });
 ...
 $(document).on('change', '#to_id,#from_id', function (e) {
    ...
    var telemarketer_id = $('#telemarketer_id').val();
            ...
            $.ajax({
                type: "GET",
                url:"<?php echo get_uri("customers/get_totidc_suggestion") ?>",
