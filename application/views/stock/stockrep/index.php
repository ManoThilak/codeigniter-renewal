<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul id="expenses-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang("stock"); ?></h4></li>
            ...
            <li><a role="presentation" href="<?php echo_uri("expenses/custom/"); ?>" data-target="#custom-expenses"><?php echo lang('report'); ?></a></li>
...
<script type="text/javascript">
    loadExpensesTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("stockrep/list_data") ?>',
