<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul id="payment-received-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white inner" role="tablist">
            ...
            <li><a role="presentation" href="<?php echo_uri("pinvoice_payments/yearly/"); ?>" data-target="#yearly-payments"><?php echo lang('yearly'); ?></a></li>
            <li><a role="presentation" href="<?php echo_uri("pinvoice_payments/custom/"); ?>" data-target="#custom-payments"><?php echo lang('custom'); ?></a></li>
            <li><a role="presentation" href="<?php echo_uri("pinvoice_payments/yearly_chart/"); ?>" data-target="#yearly-chart"><?php echo lang('chart'); ?></a></li>
        </ul>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade" id="team_member-monthly-leaves">
            ...
            <script type="text/javascript">
                ...
                $(selector).appTable({
                source: '<?php echo_uri("pinvoice_payments/payment_list_data/") ?>',
                        order: [[0, "asc"]],
