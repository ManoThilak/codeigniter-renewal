        ...
        <div class="panel-body">
            ...
            <ul class="permission-list">
               ...
               <!--  <li>
                ...
                <li>
                    <h5><?php echo lang("can_access_customers_information"); ?></h5>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "customers_no",
                            ...
                            "value" => "",
                                ), $customers, ($customers === "") ? true : false);
                        ?>
                        <label for="customers_no"><?php echo lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "name" => "customers_permission",
                            "value" => "all",
                                ), $customers, ($customers === "all") ? true : false);
                        ?>
                        <label for="customers_yes"><?php echo lang("yes"); ?></label>
                    </div>
                </li>
                <li>
                    <h5><?php echo lang("can_access_salesmanager_information"); ?></h5>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "salesmanager_no",
                            "name" => "salesmanager_permission",
                            "value" => "",
                                ), $salesmanager, ($salesmanager === "") ? true : false);
                        ?>
                        <label for="salesmanager_no"><?php echo lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "name" => "salesmanager_permission",
                            "value" => "all",
                                ), $salesmanager, ($salesmanager === "all") ? true : false);
                        ?>
                        <label for="salesmanager_yes"><?php echo lang("yes"); ?></label>
                    </div>
                </li>
                <li>
                    <h5><?php echo lang("can_access_telemarketing_information"); ?></h5>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "telemarketing_no",
                            "name" => "telemarketing_permission",
                            "value" => "",
                                ), $telemarketing, ($telemarketing === "") ? true : false);
                        ?>
                        <label for="telemarketing_no"><?php echo lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "telemarketing_yes",
                            "name" => "telemarketing_permission",
                            "value" => "all",
                                ), $telemarketing, ($telemarketing === "all") ? true : false);
                        ?>
                        <label for="telemarketing_yes"><?php echo lang("yes"); ?></label>
                    </div>
                </li>
                <li>
                    <h5><?php echo lang("can_access_telecallers_information"); ?></h5>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "telecallers_no",
                            "name" => "telecallers_permission",
                            "value" => "",
                                ), $telecallers, ($telecallers === "") ? true : false);
                        ?>
                        <label for="telecallers_no"><?php echo lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "name" => "telecallers_permission",
                            "value" => "all",
                                ), $telecallers, ($telecallers === "all") ? true : false);
                        ?>
                        <label for="telecallers_yes"><?php echo lang("yes"); ?></label>
                    </div>
                </li>
                <li>
                    <h5><?php echo lang("can_access_giftpack_information"); ?></h5>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "giftpack_no",
                            "name" => "giftpack_permission",
                            "value" => "",
                                ), $giftpack, ($giftpack === "") ? true : false);
                        ?>
                        <label for="giftpack_no"><?php echo lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "name" => "giftpack_permission",
                            "value" => "all",
                                ), $giftpack, ($giftpack === "all") ? true : false);
                        ?>
                        <label for="giftpack_yes"><?php echo lang("yes"); ?></label>
                    </div>
                </li>
                <li>
                    <h5><?php echo lang("can_access_stock_information"); ?></h5>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "stock_no",
                        ...
                        ?>
                        <label for="stock_no"><?php echo lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "name" => "stock_permission",
                            "value" => "all",
                                ), $stock, ($stock === "all") ? true : false);
                        ?>
                        <label for="stock_yes"><?php echo lang("yes"); ?></label>
                    </div>
                </li>
                <li>
                    <h5><?php echo lang("can_access_courier_information"); ?></h5>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "courier_no",
                            "name" => "courier_permission",
                            "value" => "",
                                ), $courier, ($courier === "") ? true : false);
                        ?>
                        <label for="courier_no"><?php echo lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "name" => "courier_permission",
                            "value" => "all",
                                ), $courier, ($courier === "all") ? true : false);
                        ?>
                        <label for="courier_yes"><?php echo lang("yes"); ?></label>
                    </div>
                </li>
                <li>
                    <h5><?php echo lang("can_access_couriersent_information"); ?></h5>
                    <div>
                        <?php
                        echo form_radio(array(
                            "id" => "couriersent_no",
                            "name" => "couriersent_permission",
                            "value" => "",
                                ), $couriersent, ($couriersent === "") ? true : false);
                        ?>
                        <label for="couriersent_no"><?php echo lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "name" => "couriersent_permission",
                            "value" => "all",
                                ), $couriersent, ($couriersent === "all") ? true : false);
                        ?>
                        <label for="couriersent_yes"><?php echo lang("yes"); ?></label>
                    </div>
                </li>
