...
?>" || 0;
        ...
        $("#project-table").appTable({
            ...
            source: '<?php echo_uri("customers/list_gift_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
            // hideTools: hideTools,
            // multiSelect: [
            //     {
            ...
            columns: [
                ...
                //{title: '<?php echo lang("client_name") ?>', "class": "w10p"},
                //{visible: false, searchable: false},
                {title: '<?php echo lang("birth_date") ?>', "class": "w10p"},
               // {visible: false, searchable: false},
                {title: '<?php echo lang("anniversary_date") ?>', "class": "w10p"},
                {title: '<?php echo lang("gift_for") ?>', "class": "w15p"},
                {title: '<?php echo lang("courier_date") ?>', "class": "w10p"},
                {title: '<?php echo lang("courier_name") ?>', "class": "w15p"},
                {title: '<?php echo lang("tracking_num") ?>', "class": "w15p"}
