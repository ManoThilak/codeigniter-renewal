<div id="page-content" class="p20 clearfix">
    <div class="panel clearfix">
        <ul id="client-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li><a id="clients-button" class="active" role="presentation" href="javascript:;" data-target="#clients"><?php echo lang('telemarketers'); ?></a></li>
            ...
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    ...
                    <!-- <?php echo modal_anchor(get_uri("telemarketers/telemarketers_tele_fields"), "<i class='fa fa-plus-circle'></i> " . lang('assign_to_telemarketer'), array("class" => "btn btn-default", "title" => lang('assign_to_telemarketer'))); ?> -->
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadClientsTable = function (selector) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("telemarketers/list_data") ?>',
            filterDropdown: [
