...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="invoice_due_date" class=" col-md-3">Expiry Date</label>
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "invoice_due_date",
    ...
    <div class="form-group">
    <label for="domain_name" class="col-md-3"><?php echo lang('domain_name'); ?><small class="req"> *</small></label>
    <div class="col-md-9">
        <?php
        echo form_input(array(
            "id" => "domain_name",
            "name" => "domain_name",
            "value" => $model_info->domain_name,
            "class" => "form-control",
            "placeholder" => lang('domain_name'),
            "data-rule-required" => true,
            "data-msg-required" => lang("field_required"),
            ));
        ?>
    ...
    <?php if (!$model_info->entry_id) { ?>
        <div class="form-group">
            <label for="entry_id" class=" col-md-3"><?php echo lang('entry_by'); ?></label>
            <div class="col-md-9">
                <?php
                echo form_dropdown("entry_id", $entry_dropdown, array($model_info->entry_id), "class='select2 entry-select2' id='entry_id'");
                ?>
            </div>
        </div>
    <?php } ?>
    ...
    <!-- <div class="form-group">
        <label for="tax_id" class=" col-md-3"><?php echo lang('cgst'); ?></label>
        <div class="col-md-9">
            <?php
    ...
    <div class="form-group">
        <label for="tax_id" class=" col-md-3"><?php echo lang('sgst'); ?></label>
        <div class="col-md-9">
            <?php
    ...
    <div class="form-group">
        <label for="tax_id" class=" col-md-3"><?php echo lang('igst'); ?></label>
        <div class="col-md-9">
            <?php
            echo form_dropdown("tax_id3", $taxes_dropdown, array($model_info->tax_id3), "class='select2 tax-select2' id='tax_id3'");
            ?>
        </div>
    </div> -->
    <!-- <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#tax_id,#tax_id2").select2().on("change", function () {
            var tax_id = $(this).val();
            if ($(this).val()) {
                 $("#tax_id3").select2("readonly", true);
                 $("#tax_id3").select2().val("");
            } else {
                $("#tax_id3").select2("readonly", false);
                
            }
        });

        $("#tax_id3").select2().on("change", function () {
            var tax_id3 = $(this).val();
            if ($(this).val()) {
                $("#tax_id").select2().val("");
                $("#tax_id").select2("readonly", true);
                $("#tax_id2").select2().val("");
                $("#tax_id2").select2("readonly", true);
                // $("#tax_id").val("");
                // $("#tax_id2").val("");
                
            } else {
                $("#tax_id").select2("readonly", false);
                $("#tax_id2").select2("readonly", false);
            }
        });
