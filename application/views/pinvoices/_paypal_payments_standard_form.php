...
<input name="return" value="<?php echo get_uri("pinvoices/preview/$invoice_id"); ?>" type="hidden"/>
<input name="cancel_return" value="<?php echo get_uri("pinvoices/preview/$invoice_id"); ?>" type="hidden"/>
