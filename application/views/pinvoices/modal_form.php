<?php echo form_open(get_uri("pinvoices/save"), array("id" => "invoice-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
     <div id="invoice-dropzone" class="post-dropzone">
    ...
    <?php } else { ?>
        <div class="form-group">
            <label for="invoice_client_id" class=" col-md-3"><?php echo lang('salesmanager'); ?></label>
            <div class="col-md-9">
                <?php
...
<script type="text/javascript">
    $(document).ready(function () {
           ...
           var uploadUrl = "<?php echo get_uri("pinvoices/upload_file"); ?>";
        var validationUrl = "<?php echo get_uri("pinvoices/validate_expense_file"); ?>";

        var dropzone = attachDropzoneWithForm("#invoice-dropzone", uploadUrl, validationUrl);
        ...
        $("#invoice-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('pinvoices/view'); ?>/" + result.id;
                }
            },
        ...
        $("#invoice_client_id").select2().on("change", function () {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("pinvoices/get_project_suggestion") ?>" + "/" + client_id,
                    dataType: "json",
