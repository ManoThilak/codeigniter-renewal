<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul id="expenses-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang("tele_report"); ?></h4></li>
...
<script type="text/javascript">
    loadExpensesTable = function (selector, dateRange) {
     ...
     //}
        ...
        $(selector).appTable({
            source: '<?php echo_uri("mtelemarketers/list_data_report") ?>',
            ...
            filterDropdown: [
                ...
                <?php } ?>
                {name: "complete_id", class: "w200", options: <?php echo $complete_dropdown; ?>},
            ...
            columns: [
                ...
                {title: "<?php echo lang("completed_date") ?>", "class": "w10p", "iDataSort": 3},
