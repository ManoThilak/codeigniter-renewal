...
class Customers extends MY_Controller {
    ...
    function index() {
        ...
        //$view_data['groups_dropdown'] = $this->Clients_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0, "id"= $this->login_user->client_id));
        $view_data['from_dropdown'] = json_encode($this->get_from_dropdown(true));
        $view_data['to_dropdown'] = json_encode($this->get_to_dropdown(true));
        $view_data['status_dropdown'] = json_encode($this->get_status_dropdown(true));
        ...
        $this->template->rander("clients/customers/index", $view_data);
    ...
    protected function get_cli_dropdown($return_json = false) {
    ...
    function modal_form() {
        ...
        $view_data['model_info'] = $this->Customers_model->get_one($client_id);
        ...
        //$view_data['package_dropdown'] = array("" => "-") + $this->Package_groups_model->get_dropdown_list(array("package_name","tot_contacts"), "id", array("deleted" => 0));
         ...
         //$view_data['status_dropdown'] = json_encode($this->get_status_dropdown(true));
         // if($client_id){
         //    $view_data['status_dropdown'] = $this->Status_master_model->get_dropdown_list(array("title"), "id", array("id" => 1));
         // } else {
    ...
    function customers_tele_fields() {
        ...
        //$view_data['package_dropdown'] = array("" => "-") + $this->Package_groups_model->get_dropdown_list(array("package_name","tot_contacts"), "id", array("deleted" => 0));
         ...
         $projects = $this->Customers_model->get_dropdown_list(array("id"), "id", array("client_id" => $project_client_id));
        ...
        $this->load->view('customers/customers_tele_modal_form', $view_data);
    }
    ...
    function save() {
       ...
       // $this->access_only_allowed_members_or_client_contact($client_id);
        ...
        // $cid['salesmanager'] = $this->Clients_model->get_one($clientid);
        //  $salesmanagerr_id = $salesmanager->salesmanager_id;
        ...
        $data = array(
            ...
            //"salesmanager_id" => $salesmanagerr_id,
    ...
    function savetele() {
       ...
       // $this->Customers_model->insert_datas($telemarketer_id, $client_id, $from_id, $to_id);
         ...
         if ($this->Customers_model->insert_datas($telemarketer_id, $client_id, $from_id, $to_id)) {
    ...
    function get_fromid_suggestion($client_id = 0) {
        $this->access_only_allowed_members();
    ...
    function get_totid_suggestion($client_id = 0, $telemarketer_id = 0, $fromid = 0, $toid = 0) {
        // $this->access_only_allowed_members();
        ...
        $to_id = $this->input->get('to_id');
         // console.log($from_id);
         //      console.log($to_id);
        $data     = $this->Customers_model->getAmountBySection($client_id,$telemarketer_id,$from_id,$to_id);
        echo json_encode($data);
    }
    function get_totidc_suggestion($client_id = 0, $telemarketer_id = 0, $fromid = 0, $toid = 0) {
        // $this->access_only_allowed_members();
        ...
        $to_id = $this->input->get('to_id');
         // console.log($from_id);
         //      console.log($to_id);
        $data     = $this->Customers_model->gettotBySection($client_id,$telemarketer_id,$from_id,$to_id);
        echo json_encode($data);
    }
    ...
    function delete() {
        ...
        if ($this->Customers_model->delete_client_and_sub_items($id)) {
    ...
    function list_data() {
        ...
        $list_data = $this->Customers_model->get_details($options)->result();
        $result = array();
    ...
    function list_datas() {
        ...
        $options = array(
            ...
            "client" => $this->login_user->client_id
        );
    ...
    function list_gift_of_client($client_id = 0) {
       ...
       // console.log($client_id);
        ...
        $list_data = $this->Customers_model->get_giftdetails($options)->result();
        $result = array();
        foreach ($list_data as $data) {
            $result[] = $this->_makegift_row($data, $custom_fields);
        }
        echo json_encode(array("data" => $result));
    }
    ...
    private function _row_data($id) {
        ...
        $data = $this->Customers_model->get_details($options)->row();
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $row_data[] = modal_anchor(get_uri("customers/modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_customer'), "data-post-id" => $data->id))
                . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_customer'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("customers/delete"), "data-action" => "delete-confirmation"));
            } else {
                $row_data[] = modal_anchor(get_uri("customers/modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_customer'), "data-post-id" => $data->id))
                ;
    ...
    private function _makegift_row($data, $custom_fields) {
        ...
        $row_data = array($data->id,
            ...
            // $data->cbirth_date,
             format_to_date($data->cbirth_date, false),
            // $data->canniversary_date,
             format_to_date($data->canniversary_date, false),
             $data->gift_for,
    ...
    function view($client_id = 0, $tab = "") {
       // $this->access_only_allowed_members();
        ...
        if ($client_id) {
            ...
            $client_info = $this->Customers_model->get_details($options)->row();
            if ($client_info) {
                ...
                $this->template->rander("customers/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add") {
        if ($client_id) {
            ...
            if ($type === "add") {
                $this->Customers_model->add_remove_star($client_id, $this->login_user->id, $type = "add");
                $this->load->view('customers/star/starred', $view_data);
            } else {
                $this->Customers_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                $this->load->view('customers/star/not_starred', $view_data);
            }
        }
    }

    function show_my_starred_clients() {
        $view_data["clients"] = $this->Customers_model->get_starred_clients($this->login_user->id)->result();
        $this->load->view('customers/star/clients_list', $view_data);
    }
    ...
    function projects($client_id) {
        ...
        $view_data['client_id'] = $client_id;
        $this->load->view("customers/projects/index", $view_data);
    }
    ...
    function payments($client_id) {
        ...
        if ($client_id) {
            $view_data["client_info"] = $this->Customers_model->get_one($client_id);
            $view_data['client_id'] = $client_id;
            $this->load->view("customers/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id) {
        ...
        if ($client_id) {
            ...
            $this->load->view("customers/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id) {
        ...
        if ($client_id) {
            ...
            $this->load->view("customers/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id) {
        ...
        if ($client_id) {
            ...
            $this->load->view("customers/estimates/estimates", $view_data);
        }
    }
    ...
    function estimate_requests($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = $client_id;
            $this->load->view("customers/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = $client_id;
            $this->load->view("customers/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "") {
        ...
        if ($view_type == "page_view") {
            ...
            $this->template->rander("customers/files/index", $view_data);
        } else {
            $this->load->view("customers/files/index", $view_data);
        }
    }
    ...
    function file_modal_form() {
        ...
        $view_data['client_id'] = $client_id;
        $this->load->view('customers/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data) {
        ...
        $description = "<div class='pull-left'>" .
                js_anchor(remove_file_prefix($data->file_name), array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("customers/view_file/" . $data->id)));
        ...
        $options = anchor(get_uri("customers/download_file/" . $data->id), "<i class='fa fa fa-cloud-download'></i>", array("title" => lang("download")));

        if ($this->login_user->user_type == "staff") {
            $options .= js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_file'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("customers/delete_file"), "data-action" => "delete-confirmation"));
        }
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            $this->load->view("customers/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "") {
        ...
        $view_data['client_info'] = $this->Customers_model->get_one($view_data['user_info']->client_id);
        $view_data['tab'] = $tab;
        if ($view_data['user_info']->user_type === "client") {
            ...
            $this->template->rander("customers/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences() {
        ...
        $this->load->view("customers/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($client_id = 0) {
        ...
        $this->load->view("customers/contacts/index", $view_data);
    }
    ...
    function add_new_contact_modal_form() {
        ...
        $this->load->view('customers/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0) {
        if ($contact_id) {
            ...
            $this->load->view('customers/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($client_id = 0) {
        if ($client_id) {
            ...
            $view_data['label_column'] = "col-md-2";
            $view_data['field_column'] = "col-md-10";
            $this->load->view('customers/contacts/company_info_tab', $view_data);
        }
    }
    ...
    function save_contact() {
        ...
        $primary_contact = $this->Customers_model->get_primary_contact($client_id);
        if (!$primary_contact) {
    ...
    private function _make_contact_row($data, $custom_fields, $hide_primary_contact_label = false) {
        ...
        $contact_link = anchor(get_uri("customers/contact_profile/" . $data->id), $full_name . $primary_contact) . $removal_request_pending;
        if ($this->login_user->user_type === "client") {
            $contact_link = $full_name; //don't show clickable link to client
        }

        $client_info = $this->Customers_model->get_one($data->client_id);

        $row_data = array(
            $user_avatar,
            $contact_link,
            anchor(get_uri("customers/view/" . $data->client_id), $client_info->customer_name),
            $data->job_title,
            $data->email,
        ...
        $row_data[] = js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_contact'), "class" => "delete", "data-id" => "$data->id", "data-action-url" => get_uri("customers/delete_contact"), "data-action" => "delete"));
    ...
    function invitation_modal() {
        ...
        $view_data["client_info"] = $this->Customers_model->get_one($client_id);
        $this->load->view('customers/contacts/invitation_modal', $view_data);
    }
    ...
    function users() {
        if ($this->login_user->user_type === "client") {
            ...
            $this->template->rander("customers/contacts/users", $view_data);
        }
    }
    ...
    function import_clients_modal_form() {
        ...
        $view_data['clients_dropdown'] = array("" => "-") + $this->Clients_model->get_dropdown_list(array("company_name"), "id", array("is_lead" => 0));
        $this->load->view("customers/import_customers_modal_form",$view_data);
    }
            ...
            foreach ($excel_file as $key => $value) {
                ...
                if ($key !== 0) {
                    ...
                    if ($client_data && count($client_data)) {
                        //save client data
                        $client_save_id = $this->Customers_model->save($client_data);
    ...
    function gdpr() {
        $view_data["user_info"] = $this->Users_model->get_one($this->login_user->id);
        $this->load->view("customers/contacts/gdpr", $view_data);
    }
    ...
    private function _make_export_data($user_info) {
        ...
        //add company info
        $client_info = $this->Customers_model->get_one($user_info->client_id);
    ...
    function request_my_account_removal() {
        if (get_setting("enable_gdpr") && get_setting("clients_can_request_account_removal")) {
            ...
            redirect("customers/contact_profile/$user_id/gdpr");
        }
    }
