...
class roles extends MY_Controller {
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            $view_data['customers'] = get_array_value($permissions, "customers");
            $view_data['salesmanager'] = get_array_value($permissions, "salesmanager");
            $view_data['telemarketing'] = get_array_value($permissions, "telemarketing");
            $view_data['telecallers'] = get_array_value($permissions, "telecallers");
            $view_data['giftpack'] = get_array_value($permissions, "giftpack");
            $view_data['stock'] = get_array_value($permissions, "stock");
            $view_data['courier'] = get_array_value($permissions, "courier");
            $view_data['couriersent'] = get_array_value($permissions, "couriersent");
    ...
    function save_permissions() {
        ...
        $customers = $this->input->post('customers_permission');
        $salesmanager = $this->input->post('salesmanager_permission');
        $telemarketing = $this->input->post('telemarketing_permission');
        $telecallers = $this->input->post('telecallers_permission');
        $giftpack = $this->input->post('giftpack_permission');
        $stock = $this->input->post('stock_permission');
        $courier = $this->input->post('courier_permission');
        $couriersent = $this->input->post('couriersent_permission');
