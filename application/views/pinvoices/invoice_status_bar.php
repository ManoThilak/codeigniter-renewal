<div class="panel panel-default  p15 no-border m0">
    ...
    <span class="ml15"><?php
        echo lang("salesmanager") . ": ";
        echo (anchor(get_uri("salesmanager/view/" . $invoice_info->client_id), $invoice_info->company_name));
        ?>
    </span> 

    <span class="ml15"><?php
        echo lang("last_email_sent") . ": ";
        echo (is_date_exists($invoice_info->last_email_sent_date)) ? $invoice_info->last_email_sent_date : lang("never");
        ?>
    </span>
    <?php if ($invoice_info->recurring_invoice_id) { ?>
        <span class="ml15">
            ...
            echo anchor(get_uri("pinvoices/view/" . $invoice_info->recurring_invoice_id), get_invoice_id($invoice_info->recurring_invoice_id));
            ?>
        </span>
    <?php } ?>
